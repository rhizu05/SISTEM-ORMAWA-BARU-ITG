<nav :class="sidebarOpen ? 'w-64' : 'w-20'" aria-label="Navigasi utama" class="bg-indigo-900 text-white transition-all duration-300 flex flex-col h-full overflow-y-auto">
    ...
    <div class="p-2 space-y-1">
        ...
        <div class="space-y-1 pb-4">
            ...
            <a href="{{ route('bkhm.saldo.index') }}" class="block p-2 rounded hover:bg-indigo-700 text-sm {{ request()->routeIs('bkhm.saldo.*') ? 'bg-indigo-700' : '' }}">Saldo</a>
            <a href="{{ route('bkhm.arsip.index') }}" class="block p-2 rounded hover:bg-indigo-700 text-sm {{ request()->routeIs('bkhm.arsip.*') ? 'bg-indigo-700' : '' }}">Arsip Surat BKHM</a>
            <a href="{{ route('bkhm.verifikasi-tempat.index') }}" class="block p-2 rounded hover:bg-indigo-700 text-sm {{ request()->routeIs('bkhm.verifikasi-tempat.*') ? 'bg-indigo-700' : '' }}">Verifikasi Tempat</a>
        </div>
        @else
        {{-- ==================== NON-ADMIN ROLES ==================== --}}
        ...
        <!-- Notifikasi -->
        <div class="pb-2">
            <a href="{{ route('notifikasi.index') }}" @if(request()->routeIs('notifikasi.*')) aria-current="page" @endif class="flex items-center justify-between p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('notifikasi.*') ? 'bg-indigo-800' : '' }}">
        ...
        <!-- Dashboard -->
        <div class="pb-2">
            <a href="{{ route('dashboard') }}" @if(request()->routeIs('dashboard')) aria-current="page" @endif class="flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('dashboard') ? 'bg-indigo-800' : '' }}">
        ...
        <div class="pb-2">
            <a href="{{ route('verifikasi.index') }}" @if(request()->routeIs('verifikasi.*')) aria-current="page" @endif class="flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('verifikasi.*') ? 'bg-indigo-800 font-semibold' : '' }}">
        ...
        <div class="space-y-1 pb-2">
            <div x-data="{ open: false }" class="group">
                <button @click="open = !open" class="w-full flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('bem.*') ? 'bg-indigo-800' : '' }}">
                ...
                <div x-show="open && sidebarOpen" class="pl-10 space-y-1 mt-1">
                    ...
                    <a href="{{ route('bem.kurasi.index') }}" class="block p-2 text-xs rounded hover:bg-indigo-700 transition-colors {{ request()->routeIs('bem.kurasi.*') ? 'bg-indigo-700' : '' }}">Kurasi Berita Ormawa</a>
        ...
        <div class="space-y-1 pb-2">
            <div x-data="{ open: false }" class="group">
                <button @click="open = !open" class="w-full flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('dashboard','wr3.*','verifikasi.*') ? 'bg-indigo-800' : '' }}">
                    <svg class="w-6 h-6 min-w-[24px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m0 11a2 2 0 002-2V5a2 2 0 00-2-2h-2" /></svg>
        ...
        <div class="space-y-1 pb-2">
            <div x-data="{ open: true }" class="group">
                <button @click="open = !open" class="w-full flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('bendahara.*','verifikasi.*') ? 'bg-indigo-800' : '' }}">
        ...
        <div class="space-y-1 pb-2">
            <div x-data="{ open: true }" class="group">
                <button @click="open = !open" class="w-full flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('bkhm.*','admin.*','verifikasi.*','peminjaman.verifikasi.*') ? 'bg-indigo-800' : '' }}">
                ...
                <div x-show="open && sidebarOpen" class="pl-4 space-y-1 mt-2">
                    ...
                    <div class="text-[10px] font-bold text-indigo-300 uppercase tracking-widest px-2 pt-2 border-t border-indigo-800">Layanan Mahasiswa</div>
        ...
        <div class="space-y-1 pb-2">
            <a href="{{ route('prestasi.index') }}" class="flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('prestasi.*') ? 'bg-indigo-800' : '' }}">
            ...
            @hasrole('ormawa')
            <a href="{{ route('aspirasi.mine') }}" class="flex items-center p-2 rounded-lg hover:bg-indigo-800 transition-colors {{ request()->routeIs('aspirasi.mine') ? 'bg-indigo-800' : '' }}">
                <svg class="w-6 h-6 min-w-[24px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>
                <span x-show="sidebarOpen" class="ml-3 text-sm font-medium truncate">Aspirasi Saya</span>
            </a>
            @endhasrole
        </div>
        @endhasanyrole
