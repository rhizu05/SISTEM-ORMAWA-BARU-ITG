...
class Router {
    ...
    private $pageMap = [
        ...
        'dashboard'                  => ['file' => 'app/views/ormawa/dashboard.php',                    'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara', 'sarpras', 'sarpras_barang']],
        ...
        'riwayat'                    => ['file' => 'app/views/ormawa/riwayat.php',                      'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'bendahara']],
        ...
        'arsip_digital'              => ['file' => 'app/views/ormawa/arsip_digital.php',                'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        ...
        'view_surat_lain'            => ['file' => 'app/views/ormawa/view_surat_lain.php',              'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        ...
        'view_lpj_otomatis'          => ['file' => 'app/views/ormawa/view_lpj_otomatis.php',            'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        'view_peminjaman'            => ['file' => 'app/views/ormawa/view_peminjaman_cetak.php',        'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        'view_proposal'              => ['file' => 'app/views/ormawa/view_proposal_otomatis.php',       'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        'detail'                     => ['file' => 'app/views/ormawa/detail.php',                      'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        'cetak_surat'                => ['file' => 'app/views/ormawa/cetak_surat.php',                  'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'bendahara']],
        'verify_page'                => ['file' => 'app/views/shared/verify_page.php',                  'roles' => []],
        'surat_balasan'              => ['file' => 'app/views/ormawa/cetak_surat.php',                  'roles' => []],
        'verifikasi'                 => ['file' => 'app/views/verifikator/verifikasi.php',              'roles' => ['bem', 'bpm', 'bkh', 'wr3']],
        'verifikasi_lpj'             => ['file' => 'app/views/verifikator/verifikasi_lpj.php',          'roles' => ['bkh', 'wr3']],
        'verifikasi_tempat'          => ['file' => 'app/views/verifikator/verifikasi_tempat.php',       'roles' => ['bkh']],
        'ajukan_pencairan'           => ['file' => 'app/views/verifikator/ajukan_pencairan.php',        'roles' => ['bkh']],
        'arsip_surat'                => ['file' => 'app/views/verifikator/arsip_surat.php',             'roles' => ['bkh']],
        'manage_users'               => ['file' => 'app/views/admin/manage_users.php',                  'roles' => ['bkh']],
        'hapus_user'                 => ['file' => 'app/views/admin/hapus_user.php',                    'roles' => ['bkh']],
        'manage_saldo'               => ['file' => 'app/views/admin/manage_saldo.php',                  'roles' => ['bkh', 'wr3']],
        'tambah_user'                => ['file' => 'app/views/admin/tambah_user.php',                   'roles' => ['bkh']],
        'edit_user'                  => ['file' => 'app/views/admin/edit_user.php',                     'roles' => ['bkh']],
        'atur_saldo'                 => ['file' => 'app/views/admin/atur_saldo.php',                    'roles' => ['bkh']],
        ...
        'atur_sistem'                => ['file' => 'app/views/admin/atur_sistem.php',                   'roles' => ['bkh']],
        ...
        'verifikasi_barang_bkkh'     => ['file' => 'app/views/verifikator/verifikasi_barang_bkkh.php',  'roles' => ['bkh']],
        'manage_regulasi'            => ['file' => 'app/views/verifikator/manage_regulasi.php',         'roles' => ['bpm']],
        'pusat_informasi'            => ['file' => 'app/views/ormawa/pusat_informasi.php',              'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        'jadwal_rapat'               => ['file' => 'app/views/ormawa/jadwal_rapat.php',                 'roles' => ['ormawa', 'bem', 'bpm', 'bkh', 'wr3', 'bendahara']],
        ...
        'buat_surat_peringatan'      => ['file' => 'app/views/verifikator/buat_surat_peringatan.php',   'roles' => ['bpm', 'bkh']],
